...
public class CountryServiceImpl implements CountryService {
	...
	@Override
	public List<Country> getCountriesByFilm(int idFilm) throws CountryServiceException {
	...
	@Override
	public Country getCountryById(int idFilm) throws CountryServiceException {
